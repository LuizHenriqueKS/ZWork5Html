 ...
 * @author luiz.silva
 */
public class ZHtmlNodeParserInstructionCloseElementBuilder implements ZHtmlNodeParserInstructionBuilder {
    ...
    public ZHtmlNodeParserInstruction build(ZHtmlNodeParserSourceReader srcReader, ZHtmlNodeParserInstructionData data) throws ZHtmlParseException {
        ...
        if (result==null){
            ...
            case ">":
                return new ZHtmlNodeParserInstructionCloseElement(srcReader.read(data, result.getStartIndex(), result.getEndIndex()), data);
            case "<":
                return new ZHtmlNodeParserInstructionCloseElement(srcReader.read(data, result.getStartIndex(), result.getStartIndex()), data);
            default:
