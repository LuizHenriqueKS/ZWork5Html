 ...
 * @author luiz.silva
 */
public class ZHtmlNodeParserInstructionOpenElementBuilder implements ZHtmlNodeParserInstructionBuilder {
    ...
    public ZHtmlNodeParserInstruction build(ZHtmlNodeParserSourceReader srcReader, ZHtmlNodeParserInstructionData data) throws ZHtmlParseException {
        ...
        if (result==null){
            ...
            case ">":
                return new ZHtmlNodeParserInstructionOpenElement(srcReader.read(data, result.getStartIndex(), result.getEndIndex()), data);
            case "<":
                return new ZHtmlNodeParserInstructionOpenElement(srcReader.read(data, result.getStartIndex(), result.getStartIndex()), data);
            default:
