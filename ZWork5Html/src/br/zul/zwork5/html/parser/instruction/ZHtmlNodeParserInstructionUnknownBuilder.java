 ...
 * @author luiz.silva
 */
public class ZHtmlNodeParserInstructionUnknownBuilder implements ZHtmlNodeParserInstructionBuilder {
    ...
    public ZHtmlNodeParserInstruction build(ZHtmlNodeParserSourceReader srcReader, ZHtmlNodeParserInstructionData data) throws ZHtmlParseException {
        ...
        if (result==null){
            ...
            case ">":
                return new ZHtmlNodeParserInstructionUnknown(srcReader.read(data, result.getStartIndex(), result.getEndIndex()), data);
            case "<":
                return new ZHtmlNodeParserInstructionUnknown(srcReader.read(data, result.getStartIndex(), result.getStartIndex()), data);
            default:
